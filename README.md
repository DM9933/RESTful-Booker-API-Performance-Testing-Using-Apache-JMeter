...
- **Booking Operations**:
  ...
  - `GET /booking/:id` (getBooking) (https://restful-booker.herokuapp.com/booking/:id) 
  ...
  - `PUT /booking/:id` (updateBookingByPut) (https://restful-booker.herokuapp.com/booking/:id) 
  ...
  - `PATCH /booking/:id` (partialUpdateBooking) (https://restful-booker.herokuapp.com/booking/:id) 
  ...
  - `DELETE /booking/:id` (deleteBooking) (https://restful-booker.herokuapp.com/booking/:id) 
...
### 2. Generate HTML Report:
   ...
   ```
## Reports
[View All Report](https://drive.google.com/file/d/127jbb70NmBIlKxz1yrrdt0STKv5RDhm9/view?usp=sharing)
